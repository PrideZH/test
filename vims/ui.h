...
enum BUTTON 
{
	...
	EXIT_BUTTON,
	//添加修改车辆界面按钮
	INPUT_BUTTON_0, INPUT_BUTTON_1, 
	INPUT_BUTTON_2, INPUT_BUTTON_3,
	INPUT_BUTTON_4, INPUT_BUTTON_5, 
	INPUT_BUTTON_6, INPUT_BUTTON_7,
	EMPTY_BUTTON_0, EMPTY_BUTTON_1, 
	EMPTY_BUTTON_2, EMPTY_BUTTON_3, 
	EMPTY_BUTTON_4, EMPTY_BUTTON_5, 
	EMPTY_BUTTON_6, EMPTY_BUTTON_7,
	//浏览车辆界面按钮
	SORT_ID_BUTTON,
	SORT_SEAT_BUTTON,
 ...
 typedef const struct Button_info
{
	 int x, y; //按钮位置
	 int size; //按钮大小
	 const char *content; //按钮内容
}BYTTON_INFO;
 extern BYTTON_INFO add_but;
